...
<c:forEach var="p" items="${user}">
  <div class=" view-container">
      ...
      <div class="view-port">
        <!-- *****post***** -->
        <div class="post">
            <h2>User ID : <c:out value="${p.id}"/></h2><br>
            <h2>Full Name : <c:out value="${p.fullname}"/></h2><br>
            <h2>Email: <c:out value="${p.email}"/></h2><br>
            <h2>User Type : <c:out value="${p.type}"/></h2><br>
            <h2>User Name: <c:out value="${p.username}"/></h2><br>
            <h2>Status : <c:out value="${p.status}"/></h2><br>
